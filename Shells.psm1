...
Function SetWallpaper {
    ...
    Copy-Item -Path "c:\already-system-main\files\hello.png" -Destination $env:USERPROFILE\Documents -Force
...
Function CopyFiles {
    ...
    Copy-Item -Path "c:\already-system-main\files\Tools\SpaceSniffer.exe" -Destination $env:USERPROFILE\Documents -Force *>$null
    Copy-Item -Path "c:\already-system-main\files\Tools\speedtest.exe" -Destination $env:USERPROFILE\Documents -Force *>$null
    Set-Itemproperty -path "HKCU:\Control Panel\Desktop" -name WallPaper -value "$env:userprofile\Documents\hello.png"  | Out-Null
    Write-Host "[DONE]" -ForegroundColor Green -BackgroundColor Black
}
...
Function ImportStartup {
    ...
    Copy-Item -Path "C:\already-system-main\files\startup\" -Destination "c:\" -Recurse *>$null
...
Function UninstallEdge {
	...
	cd "c:\already-system-main\files" *>$null
